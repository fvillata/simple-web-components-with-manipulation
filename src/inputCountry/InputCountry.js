import template from "./InputCountry.tpl.html";
...
const bindInputEvents = (element, input) => {
    ...
    input.addEventListener("focus", () => {
        ...
        if (input.value != "italia" || input.value != "francia"  ) {
            myValue = "";
        } else {
...
class InputCountry extends HTMLElement {
    ...
    render () {
        ...
        const domErrorElement = child.querySelector(".mds-input-country__error");
